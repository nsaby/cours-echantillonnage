...
Cartographie
------------
Pour illuster les différents plans possible pour la cartographie, nous prenons comme exemple le contour d'une parcelle fourni par le package `spcosa`. Sa forme est complexe et permet de bien illustrer les caractéristiques des plans d'échantillonnage proposés.
