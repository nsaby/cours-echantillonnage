...
Ce cours est basé sur les travaux publié dans le livre [@de_gruijter_sampling_2006].
...
- NB Les probabilités d'inclusion ne doivent pas être égales !
- Il existe de nombreuses façons de sélectionner les unités de population en échantillonnage probabiliste
...
Nous avons besoin d'un certain nombres de librairies 
