...
Ces quelques notes de cours et de script `R` ont été produite pour un cours de M1 de la Faculté de Tours. https://master-environnement.univ-tours.fr/

Ce cours est basé sur les travaux publié dans le livre [@de_gruijter_sampling_2006]. Les codes `R` sont également disponibles dans l'article de Brus et al [@brus_sampling_2019] et une partie des scripts `R` utiles pour définir un plan d'échantillonnage dans l'espace sont disponibles sur le github: https://github.com/DickBrus/TutorialSampling4DSM
